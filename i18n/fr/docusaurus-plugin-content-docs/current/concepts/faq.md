...
- Le contrat est écrit dans le langage Needle, qui est développé par l'équipe de la plateforme.
- La page est écrite dans le langage Logicor, qui est un langage de modèle de page.
...
- Non, le contrat ne peut accéder qu'aux données stockées dans la blockchain.
  [CLB](about-the-platform.md#virtual-private-ecosystem) est utilisé pour traiter les sources de données externes.
...
- Oui, le contrat peut appeler d'autres contrats en utilisant une adresse directe et fournir des paramètres pour cela, ou appeler le contrat par son nom de lien. Pour plus d'informations, voir :
...
- Vous pouvez ajouter de nouveaux champs, de nouvelles entrées ou modifier les autorisations des données dans les colonnes pour les membres de l'écosystème, les rôles ou les configurations de contrat spécifiées.
  Sauf pour les contrats créés en effectuant des opérations spécifiques.
